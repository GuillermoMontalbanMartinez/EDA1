...
public class Device implements Iterable<String> {
	...
	public Device(String name) {
		...
		//Haced uso de trim() y toLowerCase() para eliminar espacios en blanco y convertir a minusculas
	...
	public void sendMessage(String msg) {
		//Como entrada tenemos una frase; haciendo uso del metodo split(" ") convertimos el String en un array de String
		//En este array tenemos las palabras que iremos insertando en words, siempre y cuando ya no existan
	...
	public boolean contains(String word) {
		//1 unica instruccion
		//Determina si contiene o no la palabra, independientemente de si word contiene mayusculas o no
		return //...;
	}
